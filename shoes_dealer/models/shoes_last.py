...
class ShoesLast(models.Model):
    ...
    sole_material_main_id = fields.Many2one('product.material', string="Sole", ondelete='restrict')
    sole_material_secondary_id = fields.Many2one('product.material', string="Sole 2nd", ondelete='restrict')
    sole_material_main_percent = fields.Float('Sole main (%)')
    sole_material_secondary_percent = fields.Float('Sole 2nd (%)')
    insole_material_id = fields.Many2one('product.material', string='Insole', ondelete='restrict')
    insole_material_percent = fields.Float('Insole material (%)')
    platform_material_id = fields.Many2one('product.material', string="Platform", ondelete='restrict')
